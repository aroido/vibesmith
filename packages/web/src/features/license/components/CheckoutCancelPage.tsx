...
export function CheckoutCancelPage() {
  ...
  return (
    <PageFrame
      activeNav="settings"
      title={t('pages.checkoutCancel.title')}
      subtitle={t('pages.checkoutCancel.subtitle')}
    >
      <section className={PANEL_CLASS}>
        <p className="text-sm text-theme-secondary">{t('pages.checkoutCancel.description')}</p>
